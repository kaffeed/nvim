...
local config = {
    ...
    on_attach = require('core.mason').on_attach,
...
nnoremap('<leader>cec', require('jdtls').extract_constant, opts)
nnoremap('<leader>cem', require('jdtls').extract_method, opts)
nnoremap('<leader>ct', require('jdtls').test_nearest_method, opts)
nnoremap('<leader>cT', require('jdtls').test_class, opts)
nnoremap('<leader>cu', '<cmd>JdtUpdateConfig<CR>', opts)
